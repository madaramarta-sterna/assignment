...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-15 lg:p-15 items-center min-h-screen flex-col justify-start gap-[15px]">
<header
    class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden box-shadow fixed top-[0] bg-[#FDFDFC] p-2">
